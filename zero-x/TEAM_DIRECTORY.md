# EX Venture Team Directory

**Last Updated:** 2026-02-05  
**Status:** Active — For Agent Reference

---

## Executive Leadership

| Name | Role | Email | Function |
|--------------------|-----------------------|---------------------------|--------------------------------------|
| **Julien Uhlig** | Founder & CEO | julien@exventure.co | Master Agent, final decision authority |
| Yuvaprasanth Murugan | Director of Operations | management@exventure.co | Day-to-day ops, team coordination |
| Diogo Lagoa da Costa | Canary Islands Director | diogolagoadacosta@gmail.com | Spain operations, company setup |

---

## Project Leads

| Name | Role | Email | Project | Function |
|------------------------|------------------------|---------------------------|------------|------------------------------------------|
| Marco | Head of Seraph Vision AI | seraph@exventure.co | Seraph AI | AI agriculture, duckweed, vertical farming |
...
| Department | Lead | Email | Team Members |
|--------------------|------------------|------------------------|------------------------------|
| Marketing | Taefa Sultana Rima | marketing@exventure.co | Ardin, Alfian (video) |
...
|-------------------|------------------------|-------------------------------|------------------------|
| Mr. Rapp | Accountant (Bader-Hesse) | drapp@bader-hesse.de | German accounting |

---

## Key Entities

| Entity | Relationship | Lead | Focus |
|--------|--------------|------|-------|
| **EX Venture** | Parent/Holding | Julien Uhlig | Master company |
| **Zero-X Labs** | Subsidiary | Clemens | Waste gasification, X-150, CCM |
| **MFC/Energaia** | Subsidiary/Partner | Michael Hofmeister | Germany ops, biochar |
| **Seraph Vision AI** | Subsidiary | Marco | AI agriculture, duckweed |
| **Equation Labs** | Partner (Spain) | — | EQL manufacturing |
